# retention_by_subscription_plan.py
...
bars = plt.bar(agg['subscription_plan'], agg['retention'], color='mediumpurple')
...
plt.title('12-Month Retention Rate by Subscription Plan')
