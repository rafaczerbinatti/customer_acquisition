...
grouped = (
    df
    .groupby(['age_group', 'acquisition_source'])
    .size()
...
# Formatting
ax.set_title('Acquisition Source by Age Group')
ax.set_xlabel('')
ax.set_ylabel('')
...
# Move legend outside
ax.legend(title='Acquisition Source', bbox_to_anchor=(1.02, 1), loc='upper left')
plt.tight_layout()
plt.show()
